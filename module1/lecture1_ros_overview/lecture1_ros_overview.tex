...
% Tristan Hill - August 08, 2020 - August 22, 2021 - August 2 4, 2023
% Module 1
...
%\usepackage{/home/tntech.edu/thill/courses/ros_workshop/ros_lecture}
...
Where did ROS come from?
            \begin{itemize}
                ...
                \item We are going to use ROS \rosDistro \hspace{1mm} in \hspace{1mm} \osdistro (\href{http://wiki.ros.org/Distributions}{timeline})
            \end{itemize} 
...
\section{\sectiontitleV}	
 ...
 \setbeamertemplate{itemize items}[triangle]
                \begin{itemize}
                    ...
                    \item {\bf Next Week:} After completion of Module 1, you will be ready to install the ROS \rosDistro\hspace{1mm} software package in \osdistro. This is described in detail in Module 2. \vspc
