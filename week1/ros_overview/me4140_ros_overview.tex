...
\newcommand{\sectiontitleV}{Getting Started!}
...
You have three programs to install. A detailed description of this process with screenshots is provided in {\it virtualize\_ubuntu.pdf}.  

 \setbeamertemplate{enumerate items}[ball]
                \begin{enumerate}

					\item First download and install VirtualBox from Oracle which is an application for {\it virtualizing} operating systems on top of an existing one. \vspc         
               
                    \item Next dowload the ubuntu installation .iso file and setup a virtual operating system for learning ROS. This requires a large file that I recommend downloading ahead of time.
    
                    \item Finally, install the ROS Melodic software package in Ubuntu 18.04 using the in the terminal with the program apt. \vspc
