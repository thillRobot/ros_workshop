...
\begin{itemize}
	\item {\bf\RD Copy and Paste Errors:} {\RD It is strongly recommended to download this PDF and view it in Ubuntu so that you can copy and paste the required commands correctly.}
