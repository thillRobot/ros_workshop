...
% This is the lecture for the ME4140 ROS workshop
...
\begin{itemize}
	...
	\frame{ \small
		\frametitle{\sectiontitleI}
			Ubuntu is a {\B distribution} of Linux
            \begin{itemize}
                \item 
                \item 
                \item 
...
\section{\sectiontitleII}	
	...
	\frame{ \small
		\frametitle{\sectiontitleI}
            ...
            \begin{itemize}
                \item Unix was developed at ATT
                \item Linus Torvalds   
                \item read the whole story \href{https://en.wikipedia.org/wiki/History_of_Linux}{here}
            \end{itemize} 
